 ...
 */
public class IListsFragment extends ListFragment {
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            ...
            // Set the ListSelectionListener for communicating with the IBrowserFragment
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        setListAdapter(new ArrayAdapter<String>(getActivity(), R.layout.listfragment, IndianapolisMainActivity.myIArray));
